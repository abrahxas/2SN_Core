...
class FriendListController extends Controller
{
    ...
    public function updateAction(Request $request, $friendGroupId)
    {
        $entityManager = $this->getDoctrine()->getManager();
        $user = $this->container->get('security.context')->getToken()->getUser();
    ...
    public function deleteAction($friendGroupId)
    {
        $entityManager = $this->getDoctrine()->getManager();
        $user = $this->container->get('security.context')->getToken()->getUser();
        ...
        $friendListmoove = $entityManager->getRepository('CoreFriendListBundle:Friend')->findBy(array('friendgroup'=>$friendGroupId));
